...
<form name="input" action="<?php echo url_for('travelRoute/addAdvertPasagerQuery'); ?>" method="POST">
    <fieldset class="fieldsetStyle">
        ...
        <table border="0"> 
            ...
            <tr>
                <td>
                    Numarul de pasageri:<span class="required">*</span>
                </td>
                <td>
            ...
            <tr> 
                <td>
                    Locul de plecare:<span class="required">*</span> 
                </td>
                <td>
